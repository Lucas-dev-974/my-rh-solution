...
export default function () {
  ...
  return (
    <div
      id="employees-board"
      class="h-[80vh] mt-7 overflow-y-scroll bg-[var(--gray)] rounded-[5px] py-5"
    >
            ...
            <table className="min-w-full divide-y divide-gray-300 text-white">
              <thead>
                <tr>
                  <th
                    scope="col"
                    className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold  sm:pl-0 flex items-center gap-2"
                  >
                    <input
                      id="comments"
